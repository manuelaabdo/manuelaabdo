...
Atualmente, curso **Desenvolvimento de Sistemas no SENAI/SP**, onde busco conectar a lógica da programação com as minhas grandes paixões: a **Astronomia** e o **Foguetemodelismo**. Acredito que o código é a ferramenta que nos permite explorar o universo e transformar dados em descobertas.
...
![Texto Alternativo](caminho/do/seu/gif.gif)
